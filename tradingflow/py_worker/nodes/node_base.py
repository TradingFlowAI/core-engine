...
from tradingflow.common.exceptions.tf_exception import NodeStopExecutionException
...
from tradingflow.py_worker.common.state_store import StateStoreFactory
...
class NodeBase(abc.ABC):
    ...
    async def _initialize_log_service(self):
        ...
        if self._log_service is None:
            try:
                from tradingflow.common.db.services.flow_execution_log_service import (
