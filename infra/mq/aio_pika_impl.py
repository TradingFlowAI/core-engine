"""aio_pika Message Queue Implementation"""
...
from infra.mq.interfaces import Consumer, Publisher
...
class AioPikaTopicPublisher(Publisher):
    ...
    async def connect(
        ...
        for attempt in range(max_retries):
            try:
                ...
                # Use connection pool to get connection and channel
    ...
    async def close(self) -> None:
        ...
        # Only close channel, connection is managed by connection pool
